...
RegisterNetEvent('zul:setVehicleProperties', function(netid, data)
    local timeout = 100
    ...
    if timeout > 0 then
        zlib.setVehicleProperties(NetToVeh(netid), data)
    end
end)

---@param vehicle number
---@return VehicleProperties?
function zlib.getVehicleProperties(vehicle)
...
---@return boolean?
function zlib.setVehicleProperties(vehicle, props)
